 ...
 * from `@moribashi/web`. Merged into `WebRequestCradle` below, so importing
 * `@moribashi/auth` makes these visible on `request.scope`.
 */
...
declare module '@moribashi/web' {
  interface WebRequestCradle extends AuthCradle {}
}
